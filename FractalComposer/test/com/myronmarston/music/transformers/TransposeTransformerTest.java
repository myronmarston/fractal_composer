...
public class TransposeTransformerTest {
    ...
    public void transposeTransformer() {
        ...
        input.add(new Note(0, 1, 4, 0, new Fraction(1, 2), 64, null, 0));
        input.add(new Note(1, 2, 4, 0, new Fraction(1, 2), 64, null, 0));
        input.add(new Note(0, 0, 4, 0, new Fraction(1, 1), 64, null, 0));
        ...
        expectedOutput.add(new Note(4, 5, 4, 0, new Fraction(1, 2), 64, null, 0));
        expectedOutput.add(new Note(5, 6, 4, 0, new Fraction(1, 2), 64, null, 0));
        expectedOutput.add(new Note(4, 4, 4, 0, new Fraction(1, 1), 64, null, 0));     
        ...
        expectedOutput.add(new Note(-2, -2, 4, 0, new Fraction(1, 1), 64, null, 0));
        expectedOutput.add(new Note(-2, -1, 4, 0, new Fraction(1, 2), 64, null, 0));
        expectedOutput.add(new Note(-1, 0, 4, 0, new Fraction(1, 2), 64, null, 0));
        expectedOutput.add(new Note(-2, -2, 4, 0, new Fraction(1, 1), 64, null, 0));
        expectedOutput.add(Note.createRest(new Fraction(1, 1)));
        assertTransformerProducesExpectedOutput(t, input, expectedOutput);
    }
