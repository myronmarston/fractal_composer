...
public class ScaleTest {
    ...
    public void setNotePitchValues() throws InvalidKeySignatureException {
        ...
        s = new NaturalMinorScale(NoteName.Ab); // Ab Bb Cb Db Eb Fb Gb Ab     
    ...
    public void majorScale_convertToMidiNote_accidental() throws InvalidKeySignatureException {
        ...
        note = new Note(3, 3, 4, 1, new Fraction(1, 1), 70, scale, 0);                      
        result = note.convertToMidiNote(new Fraction(0, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, false);
        ...
        note = new Note(2, 2, 4, -2, new Fraction(1, 1), 70, scale, 0);                      
        result = note.convertToMidiNote(new Fraction(0, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, false);
        assertMidiNoteValues(result, 63, 70, 0, midiTickResolution); 
        ...
        note = new Note(0, 0, 4, -1, new Fraction(1, 1), 70, scale, 0);                      
        result = note.convertToMidiNote(new Fraction(0, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, false);
        assertMidiNoteValues(result, 60, 70, 0, midiTickResolution); 
        
        // Cbb - this note should convert ok.
        note = new Note(0, 0, 4, -2, new Fraction(1, 1), 70, scale, 0);                      
        result = note.convertToMidiNote(new Fraction(0, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, false);
    ...
    public void majorScale_convertToMidiNote() throws InvalidKeySignatureException {                
        ...
        note = new Note(0, 0, 4, 0, new Fraction(6, 1), 70, scale, 0);      
        int midiTickResolution = 8;
        
        result = note.convertToMidiNote(new Fraction(0, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, true);
        assertMidiNoteValues(result, 60, 70, 0, 48);                
        
        note.setScaleStep(5);
        note.setOctave(5);
        result = note.convertToMidiNote(new Fraction(5, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, true);
    ...
    public void minorScale_convertToMidiNote() throws InvalidKeySignatureException {                
        NaturalMinorScale scale = new NaturalMinorScale(NoteName.C);
        MidiNote result;
        Note note;
        
        note = new Note(6, 6, 4, 0, new Fraction(6, 1), 70, scale, 0);      
        int midiTickResolution = 8;
    ...
    public void majorPentatonicScale_convertToMidiNote() throws InvalidKeySignatureException {                
        ...
        note = new Note(4, 4, 4, 0, new Fraction(6, 1), 70, scale, 0);      
        int midiTickResolution = 8;
    ...
    public void chromaticScale_convertToMidiNote() throws InvalidKeySignatureException {
        ...
        result = note.convertToMidiNote(new Fraction(2, 1), midiTickResolution, MidiNote.DEFAULT_CHANNEL, false);
    ...
    public void getScaleTypes() throws InvalidKeySignatureException {                
        ...
        assertTrue(Scale.SCALE_TYPES.containsKey(NaturalMinorScale.class));
        assertEquals(Scale.SCALE_TYPES.get(NaturalMinorScale.class), Tonality.Minor.getValidKeyNames());
        assertTrue(Scale.SCALE_TYPES.containsKey(HarmonicMinorScale.class));
        assertEquals(Scale.SCALE_TYPES.get(HarmonicMinorScale.class), Tonality.Minor.getValidKeyNames());
        ...
        assertEquals(Scale.SCALE_TYPES.get(MinorPentatonicScale.class), Tonality.Minor.getValidKeyNames());
    ...
    public void getValidKeyNames() throws InvalidKeySignatureException {
        ...
        assertEquals(Tonality.Minor.getValidKeyNames(), (new NaturalMinorScale()).getValidKeyNames());
    ...
    public void scaleDefaultKeys() throws InvalidKeySignatureException {
        ...
        assertEquals(NoteName.A, (new NaturalMinorScale()).getKeyName());
