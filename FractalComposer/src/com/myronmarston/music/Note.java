...
public class Note {   
    ...
    public int hashCode() {
        int hash = 5;
        hash = 59 * hash + this.scaleStep;
        hash = 59 * hash + this.octave;
        hash = 59 * hash + this.chromaticAdjustment;
        hash = 59 * hash + (this.duration != null ? this.duration.hashCode() : 0);
        hash = 59 * hash + this.volume;
        return hash;
    }                
}
